class HelpService
  def self.call
    ...
    response += "Traduzir do inglês\n"
    response += "`Traduz uma frase em inglês para português.`\n\n"
    response += "Traduzir para inglês\n"
    response += "`Traduz uma frase em portugues para inglês.`\n\n"
    response
  end
end
